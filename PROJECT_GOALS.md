...
| **Rules teaching & UX clarity**    | Provide in-client teaching flows, weird-state explanations, and end-of-game explanations aligned with [`docs/UX_RULES_TEACHING_SCENARIOS.md`](docs/UX_RULES_TEACHING_SCENARIOS.md:1) and `gameEndExplanation.ts` | Ensures complex mechanics are learnable and understandable     |
...
| **Rules‑UX telemetry & teaching** | Instrument key rules interactions (ANM, forced elimination, weird states, territory cascades) and maintain teaching overlays and scenarios per [`docs/UX_RULES_TELEMETRY_SPEC.md`](docs/UX_RULES_TELEMETRY_SPEC.md:1) and [`docs/UX_RULES_TEACHING_SCENARIOS.md`](docs/UX_RULES_TEACHING_SCENARIOS.md:1) | Observability into player confusion and real‑world rule usage |
...
High-level risk framing and historical assessment for this area are summarised in [`docs/archive/assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](docs/archive/assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md:1) and [`docs/WAVE3_ASSESSMENT_REPORT.md`](docs/WAVE3_ASSESSMENT_REPORT.md:1).
