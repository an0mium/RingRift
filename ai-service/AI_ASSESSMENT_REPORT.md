...
> - For the current AI architecture and improvement backlog, prefer [`AI_ARCHITECTURE.md`](../docs/architecture/AI_ARCHITECTURE.md), this repository’s live [`AI_IMPROVEMENT_PLAN.md`](./AI_IMPROVEMENT_PLAN.md), and [`docs/ai/AI_TRAINING_AND_DATASETS.md`](../docs/ai/AI_TRAINING_AND_DATASETS.md).
> - Related docs: historical variants in [`archive/AI_ASSESSMENT_REPORT.md`](../archive/AI_ASSESSMENT_REPORT.md) and [`archive/AI_IMPROVEMENT_PLAN.md`](../archive/AI_IMPROVEMENT_PLAN.md), parity and invariants meta-docs such as [`docs/rules/PYTHON_PARITY_REQUIREMENTS.md`](../docs/rules/PYTHON_PARITY_REQUIREMENTS.md), [`docs/testing/STRICT_INVARIANT_SOAKS.md`](../docs/testing/STRICT_INVARIANT_SOAKS.md), [`tests/TEST_SUITE_PARITY_PLAN.md`](../tests/TEST_SUITE_PARITY_PLAN.md), and [`docs/rules/PARITY_SEED_TRIAGE.md`](../docs/rules/PARITY_SEED_TRIAGE.md).
>
