...
> **Note:** This ADR is a historical snapshot. Current daemon counts and names are documented in `../DAEMON_REGISTRY.md`.

## Context

The RingRift training infrastructure runs 105 daemon types across 20+ nodes:
...
As of Dec 2025, 105 daemon types organized by category (78 active, 11 deprecated, Q2 2026 removal):
