...
- Created `scripts/cluster_ssh_init.py` for secure host key management using ssh-keyscan (removed in current repo; see git history)
...
- `scripts/cluster_ssh_init.py` - New script (removed in current repo; see git history)
