...
The `DaemonManager` (`app/coordination/daemon_manager.py`) provides lifecycle management for 89 background daemons. Daemons are organized by function and can declare dependencies on other daemons.
