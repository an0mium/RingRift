...
- [x] Write `db_health.canonical_<board>.json` for each DB
  ...
  - Created: `data/games/db_health.canonical_square8_2p.json`
...
| 2025-12-20 | square8_2p               | FAIL (4/10 semantic divergence)    | FAIL (19+ violations) | data/games/db_health.canonical_square8_2p.json | Phase mismatch: Python=ring_placement, TS=territory_processing |
...
| 2025-12-20 | staging/iter0_sq8_2p     | FAIL (151 semantic, 33 structural) | TBD                   | data/games/db_health.staging_iter0_sq8_2p.json | Pre-fix data + line detection bug - 71% semantic divergence    |
