...
RAFT_ENABLED = os.environ.get("RINGRIFT_RAFT_ENABLED", "false").lower() in {"1", "true", "yes"}
RAFT_BIND_PORT = int(os.environ.get("RINGRIFT_RAFT_PORT", "4321"))
RAFT_COMPACTION_MIN_ENTRIES = int(os.environ.get("RINGRIFT_RAFT_COMPACTION_MIN", "1000"))
RAFT_AUTO_UNLOCK_TIME = float(os.environ.get("RINGRIFT_RAFT_AUTO_UNLOCK", "300.0"))  # 5 min
...
SWIM_ENABLED = os.environ.get("RINGRIFT_SWIM_ENABLED", "false").lower() in {"1", "true", "yes"}
