...
SELFPLAY_GAMES_TOTAL: Final[Counter] = Counter(
...
MODEL_PROMOTION_REJECTIONS: Final[Counter] = Counter(
...
CURRENT_MODEL_ELO: Final[Gauge] = Gauge(
...
PIPELINE_STAGE_DURATION: Final[Histogram] = Histogram(
...
DATA_SYNC_DURATION: Final[Histogram] = Histogram(
...
MODEL_SYNC_TOTAL: Final[Counter] = Counter(
