...
function main() {
  ...
  // Emit a compact JSON payload that can be pasted into the v2 territory
  // vector bundle when updating multi-step hex territory contracts.
