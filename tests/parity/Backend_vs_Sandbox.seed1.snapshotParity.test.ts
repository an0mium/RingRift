/**
 * Moved to archive/tests/parity/Backend_vs_Sandbox.seed1.snapshotParity.test.ts
 *
 * This file is kept as a stub so that older documentation references to
 * tests/parity/Backend_vs_Sandbox.seed1.snapshotParity.test.ts remain valid.
