...
describe('isEligibleForRecovery', () => {
  test('returns false when player controls stacks', () => {
    ...
    const state = createTestGameState({
      board,
      players: [
        { id: 'p1', username: 'P1', type: 'human', playerNumber: 1, isReady: true, timeRemaining: 600, ringsInHand: 0, eliminatedRings: 0, territorySpaces: 0 },
        { id: 'p2', username: 'P2', type: 'human', playerNumber: 2, isReady: true, timeRemaining: 600, ringsInHand: 5, eliminatedRings: 0, territorySpaces: 0 },
      ],
    });
  ...
  test('returns false when player has rings in hand', () => {
    ...
    const state = createTestGameState({
      board,
      players: [
        { id: 'p1', username: 'P1', type: 'human', playerNumber: 1, isReady: true, timeRemaining: 600, ringsInHand: 1, eliminatedRings: 0, territorySpaces: 0 },
        { id: 'p2', username: 'P2', type: 'human', playerNumber: 2, isReady: true, timeRemaining: 600, ringsInHand: 5, eliminatedRings: 0, territorySpaces: 0 },
      ],
    });
