/**
 * LineAggregate.core.branchCoverage.test.ts
 *
 * Core branch coverage tests for LineAggregate.
 * Covers line detection, validation, enumeration, and application.
 */
...
describe('LineAggregate - Core Branch Coverage', () => {
  // ==========================================================================
