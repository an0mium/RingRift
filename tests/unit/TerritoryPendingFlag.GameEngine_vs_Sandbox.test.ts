 ...
 */
describe('Territory pending self-elimination flag & phase parity (backend vs sandbox)', () => {
  ...
  test('pending flag and elimination semantics match across territory decision cycle', async () => {
    ...
    const sandboxElim = sandboxElimMoves.find(
    ...
    const sandboxPendingAfterElim =
      sandboxAny._pendingTerritorySelfElimination === false;
    ...
    const backendPendingAfterElim =
      backendAny.pendingTerritorySelfElimination === false;
