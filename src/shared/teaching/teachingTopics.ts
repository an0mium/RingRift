...
export const VICTORY_STALEMATE_TIPS: TeachingTip[] = [
  ...
  {
    text: 'LPS requires THREE rounds: Across all three rounds, you must have and take at least one real action while all others have none. Victory is declared after the third round completes.',
    category: 'lps',
    emphasis: 'critical',
    addressesGap: 'GAP-LPS-02',
  },
