...
export const TEACHING_SCENARIOS: readonly TeachingScenarioMetadata[] = [
  ...
  // ============================================================
  {
    ...
    stepIndex: 1,
    stepKind: 'guided',
    rulesDocAnchor: 'docs/rules/COMPLETE_RULES.md#forced-elimination-when-blocked',
  ...
  // ============================================================
  {
    ...
    stepIndex: 1,
    stepKind: 'guided',
    rulesDocAnchor: 'docs/rules/COMPLETE_RULES.md#end-of-game-stalemate-resolution',
  ...
  // ============================================================
  {
    ...
    stepIndex: 1,
    stepKind: 'guided',
    rulesDocAnchor: 'docs/rules/COMPLETE_RULES.md#last-player-standing',
  ...
  },
  {
    ...
    showInTutorialCarousel: false,
    learningObjectiveShort:
      'Understand LPS requires THREE consecutive rounds: across all three rounds you must have and take real actions while others have none, confirming you remain the only active player.',
    difficultyTag: 'intermediate',
  },
  ...
  // ============================================================
  {
    ...
    stepKind: 'guided',
    rulesDocAnchor:
      'docs/rules/COMPLETE_RULES.md#q23-what-happens-if-i-cannot-eliminate-any-rings-when-processing-a-disconnected-region',
  ...
  // ============================================================
  {
    ...
    stepIndex: 1,
    stepKind: 'guided',
    rulesDocAnchor: 'docs/rules/COMPLETE_RULES.md#chain-captures',
  ...
  // ============================================================
  {
    ...
    stepIndex: 1,
    stepKind: 'guided',
    rulesDocAnchor: 'docs/rules/COMPLETE_RULES.md#line-formation-and-processing',
