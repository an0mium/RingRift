...
[`docs/PRODUCTION_READINESS_CHECKLIST.md`](../production/PRODUCTION_READINESS_CHECKLIST.md):
...
- Builds all images using [`docker-compose.staging.yml`](../../docker-compose.staging.yml).
...
- Uses staging thresholds for k6 (`THRESHOLD_ENV=staging`) and applies stricter, production-level SLOs
  ...
  [`docs/PRODUCTION_READINESS_CHECKLIST.md`](../production/PRODUCTION_READINESS_CHECKLIST.md) and
  [`docs/operations/SLO_VERIFICATION.md`](SLO_VERIFICATION.md).
...
- SLO verification reports generated by [`tests/load/scripts/verify-slos.js`](../../tests/load/scripts/verify-slos.js)
...
[`docs/operations/SLO_VERIFICATION.md`](SLO_VERIFICATION.md) and the JSON configs under
