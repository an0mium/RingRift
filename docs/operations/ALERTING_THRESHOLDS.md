...
SLOs defined in [`STRATEGIC_ROADMAP.md`](../planning/STRATEGIC_ROADMAP.md) and
[`PROJECT_GOALS.md`](../../PROJECT_GOALS.md), and to the Prometheus alerts and
...
[`docs/testing/LOAD_TEST_BASELINE.md`](../testing/LOAD_TEST_BASELINE.md). That document is the
...
- **Primary SLOs**
  - `POST /api/auth/login`, `POST /api/games`,
    ...
    (see [`STRATEGIC_ROADMAP.md`](../planning/STRATEGIC_ROADMAP.md) §2.1).
...
- **Prometheus alerts**
  - [`HighP95Latency`](../../monitoring/prometheus/alerts.yml),
    [`HighP99Latency`](../../monitoring/prometheus/alerts.yml),
    [`HighMedianLatency`](../../monitoring/prometheus/alerts.yml)
    for HTTP latency.
  - [`HighErrorRate`](../../monitoring/prometheus/alerts.yml),
    [`ElevatedErrorRate`](../../monitoring/prometheus/alerts.yml),
    [`NoHTTPTraffic`](../../monitoring/prometheus/alerts.yml)
...
- **Primary SLOs**
  - Human move submission and stall rates, and WebSocket move
    end‑to‑end latency (see [`STRATEGIC_ROADMAP.md`](../planning/STRATEGIC_ROADMAP.md)
    §2.2).
...
- **Prometheus alerts**
  - [`HighGameMoveLatency`](../../monitoring/prometheus/alerts.yml) –
  ...
  - [`HighWebSocketConnections`](../../monitoring/prometheus/alerts.yml) for
...
- **Primary SLOs**
  - AI request latency and fallback/error rates at the AI service boundary
    (see [`STRATEGIC_ROADMAP.md`](../planning/STRATEGIC_ROADMAP.md) §2.3).
...
- **Prometheus alerts**
  - [`AIRequestHighLatency`](../../monitoring/prometheus/alerts.yml)
    via `ringrift_ai_request_duration_seconds_bucket`.
  - [`AIFallbackRateHigh`](../../monitoring/prometheus/alerts.yml) and
    [`AIFallbackRateCritical`](../../monitoring/prometheus/alerts.yml)
    via `ringrift_ai_fallback_total` and `ringrift_ai_requests_total`.
  - [`AIErrorsIncreasing`](../../monitoring/prometheus/alerts.yml) for
    AI error outcomes.
- **Dashboards**
  - **Game Performance** (`game-performance.json`) –
...
1. Treat [`STRATEGIC_ROADMAP.md`](../planning/STRATEGIC_ROADMAP.md) and
   [`PROJECT_GOALS.md`](../../PROJECT_GOALS.md) as the canonical SLO sources.
...
4. Record new baseline ranges in [`docs/testing/LOAD_TEST_BASELINE.md`](../testing/LOAD_TEST_BASELINE.md).
