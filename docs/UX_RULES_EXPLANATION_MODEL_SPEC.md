...
> **Doc Status (2025-12-05): Deprecated – superseded by `docs/ux/UX_RULES_EXPLANATION_MODEL_SPEC.md`**
>
> **Canonical spec:** `docs/ux/UX_RULES_EXPLANATION_MODEL_SPEC.md`
>
> **Note:** This legacy copy is kept for historical context; update the canonical spec instead.
>
