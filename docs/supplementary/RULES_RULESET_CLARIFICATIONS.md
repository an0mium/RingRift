...
It is intended to complement the canonical rules in [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md), the prior audit in [`archive/FINAL_RULES_AUDIT_REPORT.md`](../../archive/FINAL_RULES_AUDIT_REPORT.md), and the analysis artefacts:

- [`RULES_IMPLEMENTATION_MAPPING.md`](../rules/RULES_IMPLEMENTATION_MAPPING.md)
- [`archive/RULES_STATIC_VERIFICATION.md`](../../archive/RULES_STATIC_VERIFICATION.md)
- [`archive/RULES_DYNAMIC_VERIFICATION.md`](../../archive/RULES_DYNAMIC_VERIFICATION.md)
- [`docs/supplementary/RULES_CONSISTENCY_EDGE_CASES.md`](RULES_CONSISTENCY_EDGE_CASES.md)

Only items that are **not fully resolved** in Sections 11–12 of [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) are included here. Each CLAR entry is structured for use by an orchestrator agent to ask the human rules author targeted questions.
...
- [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) – RR-CANON-R090 text: "any stack in S that satisfies RR-CANON-R091–R093 for at least one direction has at least one legal move."
- [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) – RR-CANON-R091 Path and distance for non-capture movement.
- [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) – RR-CANON-R092 Marker interaction during non-capture movement.
- No RR-CANON-R093 definition exists in the canonical spec.

**Problem description**

RR-CANON-R090 defines movement availability in terms of stacks that "satisfy RR-CANON-R091–R093", but only RR-CANON-R091 and RR-CANON-R092 are actually defined. There is no RR-CANON-R093 rule block in [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md). This creates a dangling rule reference and minor ambiguity for downstream tooling that expects every referenced rule ID to exist.
...
- [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) – RR-CANON-R172 Last-player-standing victory: defines an explicit early victory condition when exactly one player has real actions for three consecutive full rounds and all others with material have none.
- [`docs/rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §13.3 Last Player Standing – narrative description and examples of last-player-standing as a primary victory path alongside elimination and territory.
- [`docs/rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §16.6 and [`docs/rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §16.9.4.5 – summaries that restate last-player-standing as a distinct victory path.
- [`RULES_IMPLEMENTATION_MAPPING.md`](../rules/RULES_IMPLEMENTATION_MAPPING.md) §3.8 – notes that victory logic encodes elimination, territory, last-player-standing, and stalemate via the shared `VictoryAggregate` and LPS helpers.
- [`docs/rules/ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md) ANM-SCEN-07 – documents how early LPS interacts with ANM and forced elimination.
...
- [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) – RR-CANON-R020 rings per player; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) RR-CANON-R081 and [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) RR-CANON-R082 reference a per-player `ringsPerPlayer` maximum when placing.
- [`../rules/COMPACT_RULES.md`](../rules/COMPACT_RULES.md) §1.1 version table – defines `ringsPerPlayer` = 18 (square8/hex8), 72 (square19), or 96 (hexagonal radius 12).
- [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §3.2.1 – states the fixed personal ring supply: 72 (19×19), 96 (hexagonal), 18 (8×8/hex8).
- [`archive/RULES_STATIC_VERIFICATION.md`](../../archive/RULES_STATIC_VERIFICATION.md) §2.3.3 – describes the current implementation approximation: per-player ring cap counts **all rings in stacks controlled by a player**, including captured rings of other colours, when deciding whether further placements are allowed (CCE-002).
- [`docs/supplementary/RULES_CONSISTENCY_EDGE_CASES.md`](RULES_CONSISTENCY_EDGE_CASES.md) CCE-002 – classifies this as an "implementation compromise" and recommends either canonising or tightening it.
...
- Python rules engine mirrors this behaviour for parity, as documented in [`archive/RULES_STATIC_VERIFICATION.md`](../../archive/RULES_STATIC_VERIFICATION.md) and [`archive/RULES_DYNAMIC_VERIFICATION.md`](../../archive/RULES_DYNAMIC_VERIFICATION.md).
...
- **If Interpretation B is intended (current behaviour is desired):**
  - "Can we update [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) and the Complete / Compact rules to state clearly that:
...
- CLAR-001, CLAR-002, and CLAR-003 are now **Resolved**, and their chosen interpretations have been integrated into [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md), [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md), and [`../rules/COMPACT_RULES.md`](../rules/COMPACT_RULES.md).
