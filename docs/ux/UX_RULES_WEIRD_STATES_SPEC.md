...
> **Inputs:**
>
> - Canonical rules in [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) (R070–R072, R100, R170–R173, R190–R191).
> - Behavioural catalogue [`docs/rules/ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md).
> - Edge‑case report [`docs/supplementary/RULES_CONSISTENCY_EDGE_CASES.md`](../supplementary/RULES_CONSISTENCY_EDGE_CASES.md).
> - Final audit [`archive/FINAL_RULES_AUDIT_REPORT.md`](../../archive/FINAL_RULES_AUDIT_REPORT.md).
> - Canonical copy baselines in [`docs/ux/UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md).
> - Telemetry schema in [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md).
> - Concept navigation index in [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](UX_RULES_CONCEPTS_INDEX.md) to keep reason codes aligned with rules anchors, teaching topics, and telemetry labels.
...
- Mapping tables for HUD / VictoryModal / TeachingOverlay and `rules_context` used in [`UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md).
...
This spec is part of the rules‑UX improvement loop described in [`UX_RULES_IMPROVEMENT_LOOP.md`](UX_RULES_IMPROVEMENT_LOOP.md). Concrete changes to weird‑state reason codes, HUD/VictoryModal copy, and TeachingOverlay routing are recorded in numbered iteration files under `docs/ux/rules_iterations/`:

- [`UX_RULES_IMPROVEMENT_ITERATION_0001.md`](rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md) – Initial hotspot‑oriented plan for ANM/FE loops, structural stalemate, and mini‑regions.
- [`UX_RULES_IMPROVEMENT_ITERATION_0002.md`](rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0002.md) – Backfilled record for W1–W5 work that aligned game‑end explanations (HUD + VictoryModal + TeachingOverlay) and telemetry with ANM/FE, structural stalemate, and territory mini‑regions.
- [`UX_RULES_IMPROVEMENT_ITERATION_0003.md`](rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0003.md) – Backfilled record for W1–W5 work on territory mini‑regions (Q23) and capture‑chain teaching flows.
...
1. **ANM‑Movement‑FE** – Active‑No‑Moves in the movement family of phases (movement / capture / chain_capture) where:
   ...
   - Forced elimination is available and will fire ([`RR‑CANON‑R072`](../../RULES_CANONICAL_SPEC.md), [`RR‑CANON‑R100`](../../RULES_CANONICAL_SPEC.md), ANM‑SCEN‑01 in [`ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md)).
...
3. **Structural‑Stalemate** – **Global stalemate / plateau**:
   ...
   - Game ends via tie‑break ladder (territory → eliminated rings → markers → last actor) per [`RR‑CANON‑R173`](../../RULES_CANONICAL_SPEC.md).
...
4. **LPS‑Early‑Win** – **Last‑Player‑Standing** early victory:
   ...
   - Canonical rules treat this as a distinct victory condition ([`RR‑CANON‑R172`](../../RULES_CANONICAL_SPEC.md); ANM‑SCEN‑07).
...
- Telemetry `payload.reason_code` and `rules_context` fields ([`UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md)).
...
- **Rules references:**
  - [`RR‑CANON‑R072`](../../RULES_CANONICAL_SPEC.md) (forced‑elimination entry).
  - [`RR‑CANON‑R100`](../../RULES_CANONICAL_SPEC.md) (forced elimination when blocked).
  - ANM‑SCEN‑01 in [`ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md).
- **Canonical `rules_context`:** `anm_forced_elimination` (see [`UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md)).
...
- **Rules references:**
  - [`RR‑CANON‑R100`](../../RULES_CANONICAL_SPEC.md) (forced elimination semantics).
  - [`RR‑CANON‑R205–R207`](../../RULES_CANONICAL_SPEC.md) (forced‑elimination taxonomy and progress).
  - CCE‑007 in [`RULES_CONSISTENCY_EDGE_CASES.md`](../supplementary/RULES_CONSISTENCY_EDGE_CASES.md) (selection heuristics).
...
- **Rules references:**
  - [`RR‑CANON‑R173`](../../RULES_CANONICAL_SPEC.md) (global stalemate and tiebreak ladder).
  - ANM‑SCEN‑06 in [`ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md).
...
- **Rules references:**
  - [`RR‑CANON‑R172`](../../RULES_CANONICAL_SPEC.md) (Last‑Player‑Standing).
  - ANM‑SCEN‑07 in [`ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md).
  - CCE‑006 in [`RULES_CONSISTENCY_EDGE_CASES.md`](../supplementary/RULES_CONSISTENCY_EDGE_CASES.md) (implementation compromise).
...
This section defines UX copy blocks per reason code. Where possible, it builds directly on the canonical baselines in [`UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md) §10.
...
These refine and specialise the general ANM and FE banners in [`UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md).
...
Displayed when the game ends by LPS (once engines fully implement [`RR‑CANON‑R172`](../../RULES_CANONICAL_SPEC.md)).
...
- **Doc anchor:** [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §4.4 _Forced Elimination When Blocked_; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R100.
...
- **Doc anchor:** [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §13.4 _End of Game "Stalemate" Resolution_; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R173.
...
- **Doc anchor:** [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §13.3 _Last Player Standing_; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R172.

---

### 3.3 TeachingOverlay Topics

For each weird state, TeachingOverlay SHOULD offer a deep‑dive topic, either existing (per [`UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md)) or newly added.

#### RWS‑001 / RWS‑004 (ANM + Forced Elimination)

Map both to existing topics:

- `teaching.active_no_moves` ([`TeachingOverlay.TEACHING_CONTENT.active_no_moves`](../../src/client/components/TeachingOverlay.tsx)):
  - **Title:** `"When you have no legal moves"`.
  - Focus: definition of ANM, real moves vs FE, structural stalemate.
- `teaching.forced_elimination` ([`TeachingOverlay.TEACHING_CONTENT.forced_elimination`](../../src/client/components/TeachingOverlay.tsx)):
...
- Reuse `teaching.line_bonus` ([`TeachingOverlay.TEACHING_CONTENT.line_bonus`](../../src/client/components/TeachingOverlay.tsx)) and extend copy (in a future docs pass) with a sub‑section:
...
Route to `teaching.territory` ([`TeachingOverlay.TEACHING_CONTENT.territory`](../../src/client/components/TeachingOverlay.tsx)).
...
Route to `teaching.victory_stalemate` ([`TeachingOverlay.TEACHING_CONTENT.victory_stalemate`](../../src/client/components/TeachingOverlay.tsx)).

Ensure that topic clearly enumerates the four‑step tiebreak ladder used in [`RR‑CANON‑R173`](../../RULES_CANONICAL_SPEC.md).
...
All keys above MUST use copy drawn from §3.1, possibly via [`UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md) §10 consolidation.
...
| :-------------------------------------------- | :------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------- |
| `ANM_MOVEMENT_FE_BLOCKED`                     | `victory.explain.fe_sequence`          | [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §4.4; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R100  |
| `STRUCTURAL_STALEMATE_TIEBREAK`               | `victory.explain.structural_stalemate` | [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §13.4; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R173 |
| `LAST_PLAYER_STANDING_EXCLUSIVE_REAL_ACTIONS` | `victory.explain.last_player_standing` | [`../rules/COMPLETE_RULES.md`](../rules/COMPLETE_RULES.md) §13.3; [`RULES_CANONICAL_SPEC.md`](../../RULES_CANONICAL_SPEC.md) R172 |
...
This mapping MUST be used by the telemetry layer (see [`UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md)):
...
- **Shape:**
  ...
  - Forced elimination is required under [`RR‑CANON‑R100`](../../RULES_CANONICAL_SPEC.md).
...
- [`UX_RULES_COPY_SPEC.md`](UX_RULES_COPY_SPEC.md) remains the **canonical copy source** for generic movement, capture, lines, territory, and victory text. This document only defines **weird‑state‑specific overlays** on top.
- [`UX_RULES_TELEMETRY_SPEC.md`](UX_RULES_TELEMETRY_SPEC.md) relies on the `reason_code` and `rules_context` mappings in §4.4 for:
  - `weird_state_banner_impression`,
  - `weird_state_details_open`,
  - `resign_after_weird_state`.
- For the structured payload consumed by end-of-game UX surfaces, see [`UX_RULES_EXPLANATION_MODEL_SPEC.md`](UX_RULES_EXPLANATION_MODEL_SPEC.md).
- [`UX_RULES_TEACHING_SCENARIOS.md`](UX_RULES_TEACHING_SCENARIOS.md) should reference the reason codes in §2 when defining flows that specifically demystify ANM/FE, structural stalemate, or LPS.
