...
- [`../rules/COMPACT_RULES.md`](../rules/COMPACT_RULES.md)
- [`docs/ACTIVE_NO_MOVES_BEHAVIOUR.md`](../rules/ACTIVE_NO_MOVES_BEHAVIOUR.md)
...
- [`VictoryConditionsPanel`](../../src/client/components/GameHUD.tsx)
- HUD summary rows in [`GameHUD.GameHUDFromViewModel()`](../../src/client/components/GameHUD.tsx)
- Victory messaging in [`VictoryModal`](../../src/client/components/VictoryModal.tsx) and [`toVictoryViewModel()`](../../src/client/adapters/gameViewModels.ts)
...
Short description (used in [`TeachingOverlay.TEACHING_CONTENT.victory_elimination`](../../src/client/components/TeachingOverlay.tsx)):
...
Description (used in [`TeachingOverlay.TEACHING_CONTENT.victory_territory`](../../src/client/components/TeachingOverlay.tsx)):
...
Description (used in [`TeachingOverlay.TEACHING_CONTENT.victory_stalemate`](../../src/client/components/TeachingOverlay.tsx)):
...
Used in [`TeachingOverlay.TEACHING_CONTENT.stack_movement`](../../src/client/components/TeachingOverlay.tsx):
...
Used in [`SandboxGameHost.PHASE_COPY.movement.summary`](../../src/client/pages/SandboxGameHost.tsx):
...
Used in [`TeachingOverlay.TEACHING_CONTENT.capturing`](../../src/client/components/TeachingOverlay.tsx):
...
Used in [`TeachingOverlay.TEACHING_CONTENT.chain_capture`](../../src/client/components/TeachingOverlay.tsx):
...
Used in [`SandboxGameHost.PHASE_COPY.capture`](../../src/client/pages/SandboxGameHost.tsx) and [`SandboxGameHost.PHASE_COPY.chain_capture`](../../src/client/pages/SandboxGameHost.tsx):
...
Used in [`TeachingOverlay.TEACHING_CONTENT.line_bonus`](../../src/client/components/TeachingOverlay.tsx):
...
For scenarios like `learn.lines.formation.Rules_11_2_Q7_Q20` in [`curated.json`](../../src/client/public/scenarios/curated.json):
...
Used in [`TeachingOverlay.TEACHING_CONTENT.territory`](../../src/client/components/TeachingOverlay.tsx):
...
Used in [`SandboxGameHost.PHASE_COPY.territory_processing.summary`](../../src/client/pages/SandboxGameHost.tsx):
...
The canonical short summaries used in [`SandboxGameHost.PHASE_COPY`](../../src/client/pages/SandboxGameHost.tsx):
...
- `hud.victory.ring_elimination.label` → [`VictoryConditionsPanel`](../../src/client/components/GameHUD.tsx) elimination row label.
- `hud.victory.ring_elimination.tooltip` → [`VictoryConditionsPanel`](../../src/client/components/GameHUD.tsx) elimination tooltip.
...
- `hud.stats.rings_eliminated.label` →
  - [`RingStats`](../../src/client/components/GameHUD.tsx) elimination label.
  - [`RingStatsFromVM`](../../src/client/components/GameHUD.tsx) elimination label.
  - [`CompactScoreSummary`](../../src/client/components/GameHUD.tsx) "Rings Eliminated" label.
- `victory_modal.ring_elimination.description` → [`getVictoryMessage()`](../../src/client/adapters/gameViewModels.ts) branch for `ring_elimination`.
- `victory_modal.territory.description` → [`getVictoryMessage()`](../../src/client/adapters/gameViewModels.ts) branch for `territory_control`.
- `victory_modal.lps.description` → [`getVictoryMessage()`](../../src/client/adapters/gameViewModels.ts) branch for `last_player_standing`.
- `victory_modal.structural_stalemate.description` → [`getVictoryMessage()`](../../src/client/adapters/gameViewModels.ts) branch for `game_completed`.
- `victory_modal.table.rings_eliminated.header` → [`FinalStatsTable`](../../src/client/components/VictoryModal.tsx) elimination column header.
- `hud.game_over.structural_stalemate.banner` → [`getGameOverBannerText()`](../../src/client/utils/gameCopy.ts) branch for `game_completed`.

### 9.2 Teaching & onboarding surfaces

- `teaching.ring_placement` → [`TEACHING_CONTENT.ring_placement`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.stack_movement` → [`TEACHING_CONTENT.stack_movement`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.capturing` → [`TEACHING_CONTENT.capturing`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.chain_capture` → [`TEACHING_CONTENT.chain_capture`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.lines` → [`TEACHING_CONTENT.line_bonus`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.territory` → [`TEACHING_CONTENT.territory`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.active_no_moves` → [`TEACHING_CONTENT.active_no_moves`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.forced_elimination` → [`TEACHING_CONTENT.forced_elimination`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.victory_elimination` → [`TEACHING_CONTENT.victory_elimination`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.victory_territory` → [`TEACHING_CONTENT.victory_territory`](../../src/client/components/TeachingOverlay.tsx).
- `teaching.victory_stalemate` → [`TEACHING_CONTENT.victory_stalemate`](../../src/client/components/TeachingOverlay.tsx).
- `onboarding.victory.elimination` → Ring Elimination card in [`OnboardingModal.VictoryStep`](../../src/client/components/OnboardingModal.tsx).

### 9.3 Sandbox & curated scenarios

- `sandbox.phase.movement.summary` → [`PHASE_COPY.movement.summary`](../../src/client/pages/SandboxGameHost.tsx).
- `sandbox.phase.capture.summary` → [`PHASE_COPY.capture.summary`](../../src/client/pages/SandboxGameHost.tsx).
- `sandbox.phase.chain_capture.summary` → [`PHASE_COPY.chain_capture.summary`](../../src/client/pages/SandboxGameHost.tsx).
- `sandbox.phase.line_processing.summary` → [`PHASE_COPY.line_processing.summary`](../../src/client/pages/SandboxGameHost.tsx).
- `sandbox.phase.territory_processing.summary` → [`PHASE_COPY.territory_processing.summary`](../../src/client/pages/SandboxGameHost.tsx).
- `scenario.learn.movement.basics.rulesSnippet` → `learn.movement.basics` in [`curated.json`](../../src/client/public/scenarios/curated.json).
- `scenario.learn.capture.chain.rulesSnippet` → `learn.capture.chain` in [`curated.json`](../../src/client/public/scenarios/curated.json).
- `scenario.learn.lines.formation.rulesSnippet` → `learn.lines.formation.Rules_11_2_Q7_Q20` in [`curated.json`](../../src/client/public/scenarios/curated.json).

**Curated sandbox rules‑concept mapping (runtime `public/scenarios/curated.json`)**

Each curated sandbox scenario loaded by [`loadCuratedScenarios()`](../../src/client/sandbox/scenarioLoader.ts) declares a `rulesConcept` and optional `uxSpecAnchor`:
...
- `learning.empty.hexagonal` and `learning.fourplayer.start` → `rulesConcept: 'board_intro_hex'`
  ...
  - Anchors: [`RULES_CANONICAL_SPEC.md` board types](../../RULES_CANONICAL_SPEC.md); §4 Movement semantics.
...
HUD banner text (used by [`HUDWeirdStateViewModel`](../../src/client/adapters/gameViewModels.ts) in [`GameHUD`](../../src/client/components/GameHUD.tsx) and [`MobileGameHUD`](../../src/client/components/MobileGameHUD.tsx)):
...
- This is an ANM state from [`isANMState()`](../../src/shared/engine/globalActions.ts) in the **movement family** of phases (including capture/chain, when applicable).
...
- **Game over banner copy**
  - [`getGameOverBannerText()`](../../src/client/utils/gameCopy.ts) for `reason: 'game_completed'`:
...
- [`getVictoryMessage()`](../../src/client/adapters/gameViewModels.ts) when `reason === 'game_completed'`:
...
- Desktop HUD: [`GameHUD.WeirdStateBanner` + help](../../src/client/components/GameHUD.tsx) mapped in [`GameHUDFromViewModel`](../../src/client/components/GameHUD.tsx).
- Mobile HUD: [`MobileWeirdStateBanner` + help](../../src/client/components/MobileGameHUD.tsx) mapped in [`MobileGameHUD`](../../src/client/components/MobileGameHUD.tsx).
