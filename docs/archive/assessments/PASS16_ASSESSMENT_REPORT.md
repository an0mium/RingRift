...
- **Python mirror:** [`capture_chain.py`](../../../ai-service/app/rules/capture_chain.py:1) implements Python analogues such as [`validate_capture_segment_on_board_py()`](../../../ai-service/app/rules/capture_chain.py:92), [`enumerate_capture_moves_py()`](../../../ai-service/app/rules/capture_chain.py:213), and [`apply_capture_py()`](../../../ai-service/app/rules/capture_chain.py:448), delegating final mutation to the Python [`GameEngine`](../../../ai-service/app/game_engine/__init__.py:1).
- **Hosts:**
