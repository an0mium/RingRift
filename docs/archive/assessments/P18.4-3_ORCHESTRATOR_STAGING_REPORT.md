...
Configuration matches the Phase 1 requirements defined in `docs/architecture/ORCHESTRATOR_ROLLOUT_PLAN.md`.
...
1.  **Promote to Production Preview:** With contract vectors and plateau parity green, proceed to Phase 2 of the orchestrator rollout plan:
    ...
    - Monitor orchestrator SLOs and alerts as defined in `docs/architecture/ORCHESTRATOR_ROLLOUT_PLAN.md` §6.1 (parity CI jobs, short soaks, `ringrift_orchestrator_error_rate`, and `ringrift_orchestrator_shadow_mismatch_rate`).
