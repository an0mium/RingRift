...
This plan operationalises the canonical weakest-aspect / hardest-problem assessment in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md) into a small set of concrete, high-leverage subtasks.
...
- [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md) – rules-UX telemetry schema and hotspot metrics.
- [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md) – weird-state reason codes and UX mappings.
- [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md) – scenario-driven teaching flows for complex mechanics.
- [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md) – telemetry-driven rules-UX improvement process and iteration cadence.
- [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md) – first concrete iteration focusing on ANM/FE, structural stalemate, and mini-regions.

**Implementation**

- Telemetry types and helpers:
  - [`src/shared/telemetry/rulesUxEvents.ts`](../../../src/shared/telemetry/rulesUxEvents.ts)
  - [`src/client/utils/rulesUxTelemetry.ts`](../../../src/client/utils/rulesUxTelemetry.ts)
  - [`src/server/routes/rulesUxTelemetry.ts`](../../../src/server/routes/rulesUxTelemetry.ts)
- Weird-state mapping and UX surfaces:
  - [`src/shared/engine/weirdStateReasons.ts`](../../../src/shared/engine/weirdStateReasons.ts)
  - [`src/client/components/GameHUD.tsx`](../../../src/client/components/GameHUD.tsx)
  - [`src/client/components/VictoryModal.tsx`](../../../src/client/components/VictoryModal.tsx)
- Teaching flows:
  - [`src/shared/teaching/teachingScenarios.ts`](../../../src/shared/teaching/teachingScenarios.ts)
  - [`src/client/components/TeachingOverlay.tsx`](../../../src/client/components/TeachingOverlay.tsx)
- Hotspot analyzer:
  - [`src/shared/telemetry/rulesUxHotspotTypes.ts`](../../../src/shared/telemetry/rulesUxHotspotTypes.ts)
  - [`scripts/analyze_rules_ux_telemetry.ts`](../../../scripts/analyze_rules_ux_telemetry.ts)
  - [`tests/unit/RulesUxHotspotAnalysis.test.ts`](../../../tests/unit/RulesUxHotspotAnalysis.test.ts)
...
- [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md) – tiered training and promotion pipeline for Square-8 2-player.
- [`docs/ai/AI_TIER_PERF_BUDGETS.md`](../../ai/AI_TIER_PERF_BUDGETS.md) – per-tier performance budgets and benchmark harness contracts.
- [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md) – difficulty calibration analysis and report structure.
...
- Calibration analysis:
  - [`ai-service/scripts/analyze_difficulty_calibration.py`](../../../ai-service/scripts/analyze_difficulty_calibration.py)
  - [`ai-service/tests/test_analyze_difficulty_calibration.py`](../../../ai-service/tests/test_analyze_difficulty_calibration.py)
...
Define and scope the second rules-UX iteration (`UX_RULES_IMPROVEMENT_ITERATION_0002`) driven explicitly by hotspot and weird-state telemetry. Building on the improvement loop in [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md) and the first iteration in [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md), this task produces a new iteration document that targets the next wave of confusion around ANM/FE, structural stalemates, mini-regions, and related concepts.

The iteration spec should select 2–3 top-priority rules contexts (based on telemetry from [`scripts/analyze_rules_ux_telemetry.ts`](../../../scripts/analyze_rules_ux_telemetry.ts) or, if necessary, reasoned expectations) and define concrete UX changes for HUD, VictoryModal, TeachingOverlay, and sandbox flows.

**Key dependencies**

- Assessment and framing:
  - [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md)
  - [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md)
- Iteration loop and existing iteration:
  - [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md)
  - [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md)
- Telemetry and hotspot tooling:
  - [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md)
  - [`src/shared/telemetry/rulesUxEvents.ts`](../../../src/shared/telemetry/rulesUxEvents.ts)
  - [`src/shared/telemetry/rulesUxHotspotTypes.ts`](../../../src/shared/telemetry/rulesUxHotspotTypes.ts)
  - [`scripts/analyze_rules_ux_telemetry.ts`](../../../scripts/analyze_rules_ux_telemetry.ts)
...
- New iteration spec [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0002.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0002.md) exists and:
...
The index should live as a new doc under `docs/` (for example [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md)) and act as a hub connecting rules semantics, audit findings, UX specs, teaching scenarios, and telemetry labels.
...
- Canonical rules and audits:
  ...
  - [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md)
- Rules-UX system:
  - [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md)
  - [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md)
  - [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md)
...
- A new index document [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md) exists and:
  ...
  - For each concept, lists:
    - Canonical rules references (sections or anchors in [`RULES_CANONICAL_SPEC.md`](../../../RULES_CANONICAL_SPEC.md) or [`ringrift_complete_rules.md`](../../../ringrift_complete_rules.md)).
    - Relevant UX specs and teaching scenarios.
    - Key code/telemetry identifiers (reason codes, `rulesContext`, scenario IDs).
- At least two existing docs (for example [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md) and [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md)) gain a concise “See also: concepts index” link pointing to the new document.
...
- Weird states and UX copy:
  - [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md)
  - [`docs/ux/UX_RULES_COPY_SPEC.md`](../../ux/UX_RULES_COPY_SPEC.md)
- Client surfaces:
  - [`src/client/components/GameHUD.tsx`](../../../src/client/components/GameHUD.tsx)
  - [`src/client/components/VictoryModal.tsx`](../../../src/client/components/VictoryModal.tsx)
...
- A new spec document (for example [`docs/ux/UX_RULES_EXPLANATION_MODEL_SPEC.md`](../../ux/UX_RULES_EXPLANATION_MODEL_SPEC.md)) exists and:
...
Perform a focused audit of teaching scenario coverage for the highest-risk rules contexts identified in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md): ANM/FE, structural stalemates, territory mini-regions, capture chains, and Last-Player-Standing. The goal is to ensure that each concept has at least one high-quality, discoverable teaching scenario, or is explicitly recorded as a gap.

The audit should examine both specification-level scenarios in [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md) and concrete implementations in [`src/shared/teaching/teachingScenarios.ts`](../../../src/shared/teaching/teachingScenarios.ts) and [`src/client/components/TeachingOverlay.tsx`](../../../src/client/components/TeachingOverlay.tsx), along with how they are surfaced from HUD, VictoryModal, and sandbox.
...
- Teaching specs and implementation:
  ...
  - [`src/shared/teaching/teachingScenarios.ts`](../../../src/shared/teaching/teachingScenarios.ts)
  - [`src/client/components/TeachingOverlay.tsx`](../../../src/client/components/TeachingOverlay.tsx)
  - [`src/client/pages/SandboxGameHost.tsx`](../../../src/client/pages/SandboxGameHost.tsx)

**Acceptance criteria**

- A new audit document (for example [`docs/ux/UX_RULES_TEACHING_GAP_ANALYSIS.md`](../../ux/UX_RULES_TEACHING_GAP_ANALYSIS.md)) exists and:
...
- Where appropriate, the document cross-links to [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md) so future iterations can use a single concepts vocabulary.
...
- Analysis and guidance:
  ...
  - [`docs/ai/AI_HUMAN_CALIBRATION_GUIDE.md`](../../ai/AI_HUMAN_CALIBRATION_GUIDE.md)
- Scripts and telemetry:
  - [`ai-service/scripts/analyze_difficulty_calibration.py`](../../../ai-service/scripts/analyze_difficulty_calibration.py)
  - [`ai-service/tests/test_analyze_difficulty_calibration.py`](../../../ai-service/tests/test_analyze_difficulty_calibration.py)
  - Difficulty calibration telemetry definitions and server routing (as referenced in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md)).

**Acceptance criteria**

- A new runbook [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md) exists and:
...
- A template file (for example [`docs/ai/calibration_runs/TEMPLATE.md`](../../ai/calibration_runs/TEMPLATE.md)) is added that future calibration runs can copy and fill in.
...
- Ladder pipeline and perf budgets:
  ...
  - [`docs/ai/AI_TIER_PERF_BUDGETS.md`](../../ai/AI_TIER_PERF_BUDGETS.md)
- Calibration analysis and human data:
  - [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md)
  - [`docs/ai/AI_HUMAN_CALIBRATION_GUIDE.md`](../../ai/AI_HUMAN_CALIBRATION_GUIDE.md)
- Operations and alerting:
  - [`docs/operations/ALERTING_THRESHOLDS.md`](../../operations/ALERTING_THRESHOLDS.md)

**Acceptance criteria**

- A new spec [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md) exists and:
...
- The document explicitly references how these signals should be consulted during tier promotion decisions, linking back to [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md).
...
- Calibration and monitoring:
  - [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md)
  - [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md) (from H-AI-14)
  - [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md) (from H-AI-15)

**Acceptance criteria**

- A new policy/checklist document [`docs/ai/AI_LADDER_CHANGE_GUARDRAILS.md`](../../ai/AI_LADDER_CHANGE_GUARDRAILS.md) exists and:
...
- The document is referenced from [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md) in a short “See also: change guardrails” note.
...
- Calibration runbook and monitoring (for context):
  - [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md)
  - [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md)

**Acceptance criteria**

- A new study design document [`docs/ai/AI_HUMAN_CALIBRATION_STUDY_DESIGN.md`](../../ai/AI_HUMAN_CALIBRATION_STUDY_DESIGN.md) exists and:
