...
This plan operationalises the canonical weakest-aspect / hardest-problem assessment in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md:1) into a small set of concrete, high-leverage subtasks.
...
- [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md:1) – rules-UX telemetry schema and hotspot metrics.
- [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md:1) – weird-state reason codes and UX mappings.
- [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md:1) – scenario-driven teaching flows for complex mechanics.
- [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md:1) – telemetry-driven rules-UX improvement process and iteration cadence.
- [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md:1) – first concrete iteration focusing on ANM/FE, structural stalemate, and mini-regions.
...
- [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md:1) – tiered training and promotion pipeline for Square-8 2-player.
- [`docs/ai/AI_TIER_PERF_BUDGETS.md`](../../ai/AI_TIER_PERF_BUDGETS.md:1) – per-tier performance budgets and benchmark harness contracts.
- [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md:1) – difficulty calibration analysis and report structure.
...
Define and scope the second rules-UX iteration (`UX_RULES_IMPROVEMENT_ITERATION_0002`) driven explicitly by hotspot and weird-state telemetry. Building on the improvement loop in [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md:1) and the first iteration in [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md:1), this task produces a new iteration document that targets the next wave of confusion around ANM/FE, structural stalemates, mini-regions, and related concepts.
...
- Assessment and framing:
  - [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md:210)
  - [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md:1)
- Iteration loop and existing iteration:
  - [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md:1)
  - [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0001.md:1)
- Telemetry and hotspot tooling:
  - [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md:1)
  - [`src/shared/telemetry/rulesUxEvents.ts`](../../../src/shared/telemetry/rulesUxEvents.ts:1)
  - [`src/shared/telemetry/rulesUxHotspotTypes.ts`](../../../src/shared/telemetry/rulesUxHotspotTypes.ts:1)
  - [`scripts/analyze_rules_ux_telemetry.ts`](../../../scripts/analyze_rules_ux_telemetry.ts:1)
...
- New iteration spec [`docs/ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0002.md`](../../ux/rules_iterations/UX_RULES_IMPROVEMENT_ITERATION_0002.md:1) exists and:
...
The index should live as a new doc under `docs/` (for example [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md:1)) and act as a hub connecting rules semantics, audit findings, UX specs, teaching scenarios, and telemetry labels.
...
- Canonical rules and audits:
  ...
  - [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md:1)
- Rules-UX system:
  - [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md:1)
  - [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md:1)
  - [`docs/ux/UX_RULES_TELEMETRY_SPEC.md`](../../ux/UX_RULES_TELEMETRY_SPEC.md:1)
...
- A new index document [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md:1) exists and:
...
- At least two existing docs (for example [`docs/supplementary/RULES_DOCS_UX_AUDIT.md`](../../supplementary/RULES_DOCS_UX_AUDIT.md:1) and [`docs/ux/UX_RULES_IMPROVEMENT_LOOP.md`](../../ux/UX_RULES_IMPROVEMENT_LOOP.md:1)) gain a concise “See also: concepts index” link pointing to the new document.
...
- Rules semantics and audits:
  - [`RULES_CANONICAL_SPEC.md`](../../../RULES_CANONICAL_SPEC.md:1)
  - [`docs/supplementary/RULES_TERMINATION_ANALYSIS.md`](../../supplementary/RULES_TERMINATION_ANALYSIS.md:1)
- Weird states and UX copy:
  - [`docs/ux/UX_RULES_WEIRD_STATES_SPEC.md`](../../ux/UX_RULES_WEIRD_STATES_SPEC.md:1)
  - [`docs/ux/UX_RULES_COPY_SPEC.md`](../../ux/UX_RULES_COPY_SPEC.md:1)
- Client surfaces:
  - [`src/client/components/GameHUD.tsx`](../../../src/client/components/GameHUD.tsx:1)
  - [`src/client/components/VictoryModal.tsx`](../../../src/client/components/VictoryModal.tsx:1)
...
Perform a focused audit of teaching scenario coverage for the highest-risk rules contexts identified in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md:92): ANM/FE, structural stalemates, territory mini-regions, capture chains, and Last-Player-Standing. The goal is to ensure that each concept has at least one high-quality, discoverable teaching scenario, or is explicitly recorded as a gap.

The audit should examine both specification-level scenarios in [`docs/ux/UX_RULES_TEACHING_SCENARIOS.md`](../../ux/UX_RULES_TEACHING_SCENARIOS.md:1) and concrete implementations in [`src/shared/teaching/teachingScenarios.ts`](../../../src/shared/teaching/teachingScenarios.ts:1) and [`src/client/components/TeachingOverlay.tsx`](../../../src/client/components/TeachingOverlay.tsx:1), along with how they are surfaced from HUD, VictoryModal, and sandbox.
...
- A new audit document (for example [`docs/ux/UX_RULES_TEACHING_GAP_ANALYSIS.md`](../../ux/UX_RULES_TEACHING_GAP_ANALYSIS.md:1)) exists and:
...
- Where appropriate, the document cross-links to [`docs/ux/UX_RULES_CONCEPTS_INDEX.md`](../../ux/UX_RULES_CONCEPTS_INDEX.md:1) so future iterations can use a single concepts vocabulary.
...
- Analysis and guidance:
  - [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md:1)
  - [`docs/ai/AI_HUMAN_CALIBRATION_GUIDE.md`](../../ai/AI_HUMAN_CALIBRATION_GUIDE.md:1)
- Scripts and telemetry:
  - [`ai-service/scripts/analyze_difficulty_calibration.py`](../../../ai-service/scripts/analyze_difficulty_calibration.py:1)
  - [`ai-service/tests/test_analyze_difficulty_calibration.py`](../../../ai-service/tests/test_analyze_difficulty_calibration.py:1)
  - Difficulty calibration telemetry definitions and server routing (as referenced in [`WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md`](../assessments/WEAKNESS_AND_HARDEST_PROBLEM_REPORT.md:347)).

**Acceptance criteria**

- A new runbook [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md:1) exists and:
...
- A template file (for example [`docs/ai/calibration_runs/TEMPLATE.md`](../../ai/calibration_runs/TEMPLATE.md:1)) is added that future calibration runs can copy and fill in.
...
- Ladder pipeline and perf budgets:
  - [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md:1)
  - [`docs/ai/AI_TIER_PERF_BUDGETS.md`](../../ai/AI_TIER_PERF_BUDGETS.md:1)
- Calibration analysis and human data:
  - [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md:1)
  - [`docs/ai/AI_HUMAN_CALIBRATION_GUIDE.md`](../../ai/AI_HUMAN_CALIBRATION_GUIDE.md:1)
- Operations and alerting:
  - [`docs/operations/ALERTING_THRESHOLDS.md`](../../operations/ALERTING_THRESHOLDS.md:1)

**Acceptance criteria**

- A new spec [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md:1) exists and:
...
- The document explicitly references how these signals should be consulted during tier promotion decisions, linking back to [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md:1).
...
- Calibration and monitoring:
  - [`docs/ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](../../ai/AI_DIFFICULTY_CALIBRATION_ANALYSIS.md:1)
  - [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md:1) (from H-AI-14)
  - [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md:1) (from H-AI-15)

**Acceptance criteria**

- A new policy/checklist document [`docs/ai/AI_LADDER_CHANGE_GUARDRAILS.md`](../../ai/AI_LADDER_CHANGE_GUARDRAILS.md:1) exists and:
...
- The document is referenced from [`docs/ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](../../ai/AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md:1) in a short “See also: change guardrails” note.
...
- Calibration runbook and monitoring (for context):
  - [`docs/ai/AI_CALIBRATION_RUNBOOK.md`](../../ai/AI_CALIBRATION_RUNBOOK.md:1)
  - [`docs/ai/AI_LADDER_HEALTH_MONITORING_SPEC.md`](../../ai/AI_LADDER_HEALTH_MONITORING_SPEC.md:1)

**Acceptance criteria**

- A new study design document [`docs/ai/AI_HUMAN_CALIBRATION_STUDY_DESIGN.md`](../../ai/AI_HUMAN_CALIBRATION_STUDY_DESIGN.md:1) exists and:
