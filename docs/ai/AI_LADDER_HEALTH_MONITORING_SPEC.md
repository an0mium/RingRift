...
- **Integration:** Builds upon infrastructure from:
  - [`AI_CALIBRATION_RUNBOOK.md`](AI_CALIBRATION_RUNBOOK.md) – calibration procedure
  - [`AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](AI_DIFFICULTY_CALIBRATION_ANALYSIS.md) – analysis design
  - [`AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md) – promotion pipeline
  - [`AI_TIER_PERF_BUDGETS.md`](AI_TIER_PERF_BUDGETS.md) – performance constraints

### Relationship to Calibration Runbook

The [`AI_CALIBRATION_RUNBOOK.md`](AI_CALIBRATION_RUNBOOK.md) defines **point-in-time calibration cycles** where an operator gathers data, runs analysis, and produces recommendations. This specification defines **continuous monitoring** that:
...
the ladder `think_time_ms` values. Use [`AI_TIER_PERF_BUDGETS.md`](AI_TIER_PERF_BUDGETS.md)
...
Following patterns from [`ALERTING_THRESHOLDS.md`](../operations/ALERTING_THRESHOLDS.md):
...
3. **Check for obvious causes:**
   ...
   - AI service health (see [`AIServiceDown`](../operations/ALERTING_THRESHOLDS.md))
...
2. **Prometheus metrics exporter:**
   - Extend [`MetricsService`](../../src/server/services/MetricsService.ts) with ladder health gauges:
...
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| [`AI_CALIBRATION_RUNBOOK.md`](AI_CALIBRATION_RUNBOOK.md)                                   | Defines per-cycle calibration procedure; this spec adds continuous monitoring     |
| [`AI_DIFFICULTY_CALIBRATION_ANALYSIS.md`](AI_DIFFICULTY_CALIBRATION_ANALYSIS.md)           | Defines calibration metrics and targets; this spec operationalizes them           |
| [`AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md`](AI_TIER_TRAINING_AND_PROMOTION_PIPELINE.md) | Defines training/promotion loop; this spec monitors promotion outcomes            |
| [`AI_TIER_PERF_BUDGETS.md`](AI_TIER_PERF_BUDGETS.md)                                       | Defines latency budgets; this spec monitors adherence                             |
| [`ALERTING_THRESHOLDS.md`](../operations/ALERTING_THRESHOLDS.md)                           | Defines general alerting patterns; this spec follows those patterns for AI ladder |
| [`ladder_config.py`](../../ai-service/app/config/ladder_config.py)                         | Defines ladder tier configurations; this spec monitors their health               |
| [`tier_eval_runner.py`](../../ai-service/app/training/tier_eval_runner.py)                 | Implements tier evaluation; this spec consumes its outputs                        |
