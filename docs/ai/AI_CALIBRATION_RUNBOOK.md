...
- Default path: `ai-service/config/tier_candidate_registry.square8_2p.json` (local-only, gitignored)
...
2. **Gather inputs**
   ...
   - [ ] (Optional) Snapshot `ai-service/config/tier_candidate_registry.square8_2p.json` (local-only, gitignored) into the run directory.
