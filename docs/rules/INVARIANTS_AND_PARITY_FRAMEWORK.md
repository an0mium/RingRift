...
| `PARITY-BACKEND-SANDBOX-TS` (legacy vs orchestrator)                                                       | `OrchestratorShadowMismatches` (deprecated)                                                                                               | Shadow mode was removed; the mismatch metric is no longer emitted. Use `RulesParity*` alerts and `ringrift_rules_parity_mismatches_total{suite="runtime_python_mode",...}` when running python‑authoritative diagnostics.                                                                                                                                                                                                                                                                                                                  |
