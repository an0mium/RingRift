...
- **Expected canonical behaviour (RR-CANON):**
  - Per [`RR-CANON-R172`](../../RULES_CANONICAL_SPEC.md) and clarifications in [`COMPLETE_RULES.md`](COMPLETE_RULES.md) §13.3, P should win by Last Player Standing once the “exclusive real-action” condition has held for **three consecutive full rounds** (P takes at least one real action on each of their turns; all others have none).
