...
> - Superseded by: the active AI host docs [`AI_ARCHITECTURE.md`](../docs/architecture/AI_ARCHITECTURE.md) and [`docs/ai/AI_TRAINING_AND_DATASETS.md`](../docs/ai/AI_TRAINING_AND_DATASETS.md) which describe current capabilities.
> - Not a semantics SSoT: see [`RULES_CANONICAL_SPEC.md`](../RULES_CANONICAL_SPEC.md) and [`docs/architecture/CANONICAL_ENGINE_API.md`](../docs/architecture/CANONICAL_ENGINE_API.md).
