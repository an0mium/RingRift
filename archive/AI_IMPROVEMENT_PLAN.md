...
> - Superseded by: the current AI host plan in [`ai-service/AI_IMPROVEMENT_PLAN.md`](../ai-service/AI_IMPROVEMENT_PLAN.md), the architecture overview in [`AI_ARCHITECTURE.md`](../docs/architecture/AI_ARCHITECTURE.md), and the training/meta docs [`docs/ai/AI_TRAINING_AND_DATASETS.md`](../docs/ai/AI_TRAINING_AND_DATASETS.md) and [`docs/ai/AI_TRAINING_PREPARATION_GUIDE.md`](../docs/ai/AI_TRAINING_PREPARATION_GUIDE.md).
