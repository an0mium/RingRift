...
> - Not a semantics SSoT: see [`RULES_CANONICAL_SPEC.md`](../RULES_CANONICAL_SPEC.md) and [`docs/architecture/CANONICAL_ENGINE_API.md`](../docs/architecture/CANONICAL_ENGINE_API.md) and strict invariant soaks [`docs/testing/STRICT_INVARIANT_SOAKS.md`](../docs/testing/STRICT_INVARIANT_SOAKS.md).
